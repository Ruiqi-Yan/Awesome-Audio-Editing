...
| 2025-11 | **VoiceCraft-X: Unifying Multilingual, Voice-Cloning Speech Synthesis and Speech Editing** | [arXiv](https://arxiv.org/abs/2511.12347)/[Github](https://github.com/zszheng147/VoiceCraft-X) |
| 2024-09 | **SSR-Speech: Towards Stable, Safe and Robust Zero-shot Text-based Speech Editing and Synthesis** | [arXiv](https://arxiv.org/abs/2409.07556)/[Github](https://github.com/WangHelin1997/SSR-Speech)/[HuggingFace](https://huggingface.co/westbrook/SSR-Speech-Mandarin) |
| 2024-07 | **Speech Editing – a Summary** | [arXiv](https://arxiv.org/abs/2407.17172) |
| 2024-05 | **InstructSpeech: Following Speech Editing Instructions via Large Language Models** | [Paper](https://openreview.net/forum?id=xlWcdtCyOC)/[Demo](https://instructspeech.github.io/) |
| 2024-03 | **VoiceCraft: Zero-Shot Speech Editing and Text-to-Speech in the Wild** | [arXiv](https://arxiv.org/abs/2403.16973)/[Github](https://github.com/jasonppy/VoiceCraft)/[Demo](https://jasonppy.github.io/VoiceCraft_web) |
| 2023-05 | **FluentSpeech: Stutter-Oriented Automatic Speech Editing with Context-Aware Diffusion Models** | [arXiv](https://arxiv.org/abs/2305.13612)/[Github](https://github.com/Zain-Jiang/Speech-Editing-Toolkit) |
...
| 2026-04 | **Audio-Omni: Extending Multi-modal Understanding to Versatile Audio Generation and Editing** | [arXiv](https://arxiv.org/abs/2604.10708)/[Github](https://github.com/ZeyueT/Audio-Omni)/[HuggingFace](https://huggingface.co/HKUSTAudio/Audio-Omni)/[Demo](https://zeyuet.github.io/Audio-Omni/) |
| 2026-04 | **VoiceToInstrument: Convert voice to instrumental tracks using AI** | [HomePage](https://voicetoinstrument.com)/[Blog](https://voicetoinstrument.com/blog/claude-skill-voice-to-instrument-guide) |
...
| 2024-03 | **WavCraft: Audio Editing and Generation with Large Language Models** | [arXiv](https://arxiv.org/abs/2403.09527)/[Github](https://github.com/JinhuaLiang/WavCraft)/[Demo](https://first-riddle-7e9.notion.site/WavCraft-Demo-40c079fc82ca411ca0520b9d65abd3f5) |
| 2024-02 | **Zero-Shot Unsupervised and Text-Based Audio Editing Using DDPM Inversion** | [arXiv](https://arxiv.org/abs/2402.10009)/[Github](https://github.com/HilaManor/AudioEditingCode)/[Demo](https://hilamanor.github.io/AudioEditing) |
| 2023-04 | **AUDIT: Audio Editing by Following Instructions with Latent Diffusion Models** | [arXiv](https://arxiv.org/abs/2304.00830)/[Demo](https://audit-demo.github.io/) |
